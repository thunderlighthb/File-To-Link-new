    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL is not None:
            try:
                ...
                return
        await m.reply_text(
            text="**𝙷𝙴𝙻𝙻𝙾...⚡**\n\n**𝙸𝙰𝙼 𝙰 𝚂𝙸𝙼𝙿𝙻𝙴 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 𝙵𝙸𝙻𝙴/𝚅𝙸𝙳𝙴𝙾 𝚃𝙾 𝙿𝙴𝚁𝙼𝙰𝙽𝙴𝙽𝚃 𝙻𝙸𝙽𝙺 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙾𝚁 𝙱𝙾𝚃.**\n\n**𝙸 𝙲𝙰𝙽 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴 𝙳𝙸𝚁𝙴𝙲𝚃 𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳 𝙻𝙸𝙽𝙺 𝙵𝙾𝚁 𝙰𝙽𝚈 𝚅𝙸𝙳𝙴𝙾/𝙵𝙸𝙻𝙴𝚂 𝙵𝙾𝚁 𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳𝙸𝙽𝙶 𝙾𝙽𝙻𝙸𝙽𝙴 & 𝙵𝙾𝚁 𝚂𝚃𝚁𝙴𝙰𝙼𝙸𝙽𝙶..\n\n𝚄𝚂𝙴 /help 𝙵𝙾𝚁 𝙼𝙾𝚁𝙴 𝙳𝙴𝚃𝙰𝙸𝙻𝚂...\n\n𝚂𝙴𝙽𝙳 𝙼𝙴 𝙰𝙽𝚈 𝚅𝙸𝙳𝙴𝙾/𝙵𝙸𝙻𝙴 𝚃𝙾 𝚂𝙴𝙴 𝙼𝚈 𝙿𝙾𝚆𝙴𝚁....**",
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("⚡𝚄𝙿𝙳𝙰𝚃𝙴𝚉⚡", url="https://t.me/movie_time_botonly"), InlineKeyboardButton("⚡MAIN CHANNEL⚡", url="https://t.me/Is_Movie_Time")],
                    [InlineKeyboardButton("☢️FAST LINK CHANNEL☢️", url="https://t.me/Fast_link_mt"), InlineKeyboardButton("💠CREATOR💠", url="https://t.me/FLIGHER")],
                    [InlineKeyboardButton("❇️❇️ SECOND BOT ❇️❇️", url="http://t.me/Urllitev10_bot")]
                ]
            ),
            disable_web_page_preview=True
        )
...
<b>╭━━━━━━━〔𝙵𝙸𝙻𝙴/VIDEO-𝚃𝙾-DOWNLOAD_𝙻𝙸𝙽𝙺 𝙱𝙾𝚃〕</b>
┃
┣⪼<b>𝙱𝙾𝚃-𝙽𝙰𝙼𝙴 : <b>𝙵𝙸𝙻𝙴/VIDEO-𝚃𝙾-DOWNLOAD_𝙻𝙸𝙽𝙺</b>
┣⪼<b>𝚂𝙴𝚁𝚅𝙴𝚁 : 𝙷𝙴𝚁𝚄𝙺𝙾</b>
┣⪼<b>𝙻𝙸𝙱𝚁𝙰𝚁𝚈 : 𝙿𝚁𝙾𝙶𝚁𝙰𝙼</b>
